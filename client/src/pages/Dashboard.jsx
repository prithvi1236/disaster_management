  ...
  return (
    <div className="container">
      <div
        ...
        style={{ margin: "var(--spacing-4xl) 0 var(--spacing-2xl) 0" }}
      >
        ...
        <div className="mb-2xl">
          ...
          <div className="grid grid-auto-fit gap-lg">
            <div className="card text-center">
              <h4 className="text-4xl font-bold text-primary mb-sm">
            ...
            <div className="card text-center">
              <h4 className="text-4xl font-bold text-primary mb-sm">
                ₹{stats.total_donation_amount.toLocaleString()}
              </h4>
              <p className="text-muted mb-0">Total Amount</p>
            </div>
            <div className="card text-center">
              <h4 className="text-4xl font-bold text-primary mb-sm">
                {stats.pending_resource_requests}
              </h4>
      ...
      <div className="mb-2xl">
        ...
        <div className="grid grid-cols-3 gap-lg">
          {user.role === "admin" ? (
            <>
              <a href="/admin/volunteers" className="btn btn-primary">
                Approve Volunteers
              </a>
              <a href="/admin/coordinators" className="btn btn-primary">
                Manage Coordinators
              </a>
              <a href="/admin/disasters" className="btn btn-primary">
                Manage Disasters
              </a>
              <a href="/admin/requests" className="btn btn-warning">
                Approve Requests
              </a>
              <a href="/disasters" className="btn btn-secondary">
                View Disasters
              </a>
            </>
          ) : user.role === "camp_coordinator" ? (
            <>
              <a href="/coordinator/camps" className="btn btn-primary">
                Manage My Camp
              </a>
            ...
            <>
              ...
              <a href="/volunteer-portal" className="btn btn-success">
                Volunteer Portal
              </a>
              <a href="/volunteer-signup" className="btn btn-secondary">
                Register Volunteer
              </a>
              <a href="/donate" className="btn btn-warning">
                Make Donation
              </a>
            </>
          )}
